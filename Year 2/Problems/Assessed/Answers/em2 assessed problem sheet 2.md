...
$$=\frac{Q}{4 \pi \varepsilon_0} \frac{1}{2} \left( \frac{\sqrt[  ]{ 3 }}{3}\frac{Q}{r ^{2}} \begin{pmatrix} \sqrt[  ]{ 3 } \\ 1 \end{pmatrix} + \frac{q}{r^{2}} \begin{pmatrix} \sqrt{3} \\ 1 \end{pmatrix} \right)$$
...
By solving for an arbituary point on the vertical, we will show that it is $\varphi=0$ for the entire vertical and by symmetry this applies for the horizontal as well. Further, we can equate $\left| \underline{r}_{1} \right|=\left| \underline{r}_{4} \right|$ and $\left| \underline{r}_{2} \right|=\left| \underline{r}_{3} \right|$ by symmetry again.
...
$$\underline{F}=-\frac{Q^{2}}{4\pi\varepsilon_{0}(a\sqrt[  ]{ 2 })^{2}}-\frac{Q^{2}}{4\pi\varepsilon_{0}(a\sqrt[  ]{ 2 })^{2}}+\frac{Q^{2}}{4\pi\varepsilon_{0}(2a)^{2}}=-\frac{Q^{2}}{4\pi\varepsilon_{0}a^{2}}$$