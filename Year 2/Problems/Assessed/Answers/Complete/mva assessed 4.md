...
Choose another Cartesian coordinate: $X=x+1$ and $Y=y+1$ $\implies C:X^{2}+Y^{2}=2^{2}$ and we redefined $\mathbf{F}=(X+Y-2,1-Y,1)$ and we have $dX=dx$ and $dY=dy$ so $\underline{\nabla}=\frac{ \partial  }{ \partial X }\mathbf{i}+\frac{ \partial  }{ \partial Y }\mathbf{j}+\frac{ \partial  }{ \partial z }\mathbf{k}$. 
$$\mathbf{r}(u,v)=(v\sin u,v\cos u,0)\qquad\frac{ \partial \mathbf{r} }{ \partial u } =(v\cos u,-v\sin u,0)\qquad\frac{ \partial \mathbf{r} }{ \partial v } =(\sin u,\cos u,0)$$
$$\frac{ \partial \mathbf{r} }{ \partial u } \times \frac{ \partial \mathbf{r} }{ \partial v }=(-v\sin ^{2}u-v\cos ^{2}u)\mathbf{k}=-\mathbf{k}\qquad\hat{n}= \frac{\frac{ \partial \mathbf{r} }{ \partial u } \times \frac{ \partial \mathbf{r} }{ \partial v } }{\left| \frac{ \partial \mathbf{r} }{ \partial u } \times \frac{ \partial \mathbf{r} }{ \partial v } \right|}=-\mathbf{k}$$
$$\oint_{C}\mathbf{F}\cdot d\mathbf{r}=\iint_{S}\underline{\nabla}\times \mathbf{F}\cdot \hat{n}\,dS=\iint_{R}-\mathbf{k}\cdot \hat{n}\,dS\implies -\int ^{2\pi}_{0}  \, d\theta \int ^{2}_{0}  \, dr\,r  =-4\pi$$
