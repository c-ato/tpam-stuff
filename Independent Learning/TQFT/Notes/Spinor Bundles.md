...
> - Fibres $\pi ^{-1}(x)\in E$ so that this forms a vector space itself and ${\pi ^{-1}(x)}$ is called the fibre over $x$. These are all [[Morphisms|isomorphic]] to a fixed fibre $V$, usually of $\mathbb{R}^{k}$ or $\mathbb{C}^{k}$. The $k$-dimension is also the rank of the vector bundle.
